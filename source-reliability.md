...
## 2026-08-07 (Day 161) · Source Reliability Update

### Sources cited this run

| Source | Tier | Citations this run | 4w hit rate | Status | Notes |
|---|---|---|---|---|---|
| Bloomberg (Hormuz, Rhine) | Tier 1 | 4 (Rhine 3–4 Aug, Strait transits 2 Aug) | 0.95 | Hold | Consistent reporting on Rhine as "historic low 1880", Strait closure metrics. Tone balanced; no outlier claims. Maintain Tier 1. |
| CENTCOM press releases | Tier 1 | 2 (2 Aug vessel tally: 35 redirected, 2 disabled, 2 boarded) | 0.92 | Hold | Primary US military source; numbers reported consistently across cycles. Vessel count opaque (aggregate vs. daily rate ambiguity), but internally consistent. Maintain Tier 1. |
| straits.live (maritime intelligence) | Tier 1 | 1 (Strait transits 2 Aug: 2 vs 73 baseline) | 0.88 | Hold | AIS-based tracking; publicly verifiable; transits count methodology transparent. Recent update (6 Aug posting) confirms closure sustained. Maintain Tier 1. |
| German Federal Hydrology (BfG) | Tier 1 | 2 (Kaub gauge 3–4 Aug, 14-day forecast) | 0.94 | Hold | Official government hydrological service; daily water-level readings published; forecast models transparent. Historic low (21 cm) claim verified independently by Bloomberg. Maintain Tier 1. |
| Edison (EDF Italy) press releases | Tier 1 | 3 (LNG FM extended to mid-Aug, then 30 Sept, 17 cargoes / 2.2 bcm) | 0.96 | Hold | Primary contract party; customer-facing notices are binding documents. QatarEnergy FM timelines flow through Edison announcements; no contradictions detected across cycle. Maintain Tier 1. |
| LNG Industry / energynews.pro | Tier 2 | 2 (QatarEnergy FM extensions, republishing Edison notices) | 0.87 | Hold | Secondary trade press; consolidates primary sources (Edison, company statements). Lag time ~1–2 days behind Edison release. Maintain Tier 2. |
| C&EN (Chemical & Engineering News) | Tier 2 | 2 (upstream naphtha / ethylene FM history, citation of March 2026 declarations) | 0.89 | Hold | Peer-reviewed trade press; strong archival depth; sourcing from operator FMs and analyst commentary. Lag time 2–4 weeks behind events. Maintain Tier 2. |
| Baird Maritime / ship & bunker | Tier 2 | 2 (Rhine inland shipping constraints, 3 Aug modal shift report) | 0.84 | Hold | Specialized maritime logistics outlet; operator-level information on freight rates, barge capacity, vessel utilization. Some secondary sourcing (shipping association quotes), but track record solid. Maintain Tier 2. |
| UANI (United Against Nuclear Iran) shipping reports | Tier 2 | 1 (Iranian oil tanker tracking, 66 vessels, 80 Mt crude, 4–5 Aug) | 0.79 | Watch | OSINT-driven; vessel tracking via Vortexa, satellite imagery, shipping databases. Accuracy on vessel counts ~85% (some false positives on flag-of-convenience re-flagging). Revenue estimates (IRGC funding) second-order inference, not primary. Downgrade consideration if next 3 reports show &gt;15% data variance. Current: Tier 2, note uncertainty range ±10% on vessel counts. |
| Windward Intelligence (AIS tracking, Strait analytics) | Tier 2 | 1 (suspected blockade-breaker tanker, Larak Island holding, 30 July–7 Aug) | 0.86 | Hold | Proprietary vessel-tracking algorithm; dark-mode (transponder-off) detection is specialty. High false-alarm rate on "suspicious" designations, but count data solid. Maintain Tier 2. |
| JMIC (Joint Mine Action Coordination) | Tier 1 | 0 (reference only; 5 July MOU cited, no new statement 5–7 Aug) | 0.91 (prior cycles) | Hold | Coordination authority for mine-clearance ops; statements are binding forward guidance. 5 July MOU ("40–50 days") maps to 24 Aug–23 Aug completion window, not 15 Aug (margin of error ±5 days typical). Maintain Tier 1; note that silence ≠ on-track confirmation. |
| Crisis Group (international crisis analysis) | Tier 3 | 1 (diplomatic flashpoint update, 26 July vessel interceptions) | 0.74 | Hold | Secondary source on diplomatic signaling, not primary operator data. Useful for geopolitical context but not for FM declarations or technical metrics. Maintain Tier 3. |
| phys.org (physics news aggregator, Rhine coverage) | Tier 3 | 1 (6 Aug article on Rhine low water, economic impact) | 0.68 | Watch | Aggregates from academic / research sources; interpretation can be speculative. Last article (6 Aug) on Rhine cites unnamed "economic analysts" and draws inference from 2018 drought comparison. Useful for secondary context but not primary metrics. Downgrade to Tier 3 if next Rhine article is sourced only from opinion; maintain if sourced from BfG or academic institutions. |
